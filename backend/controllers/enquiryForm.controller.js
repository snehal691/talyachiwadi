...
export const createEnquiry = asyncHandler(async (req, res) => {
   ...
   //send response
    ...
    if(!parseResult.success){
        throw new ApiError(400, parseResult?.error?.message  || "Invalid form data");
    }
...
export const getAllEnquiry = asyncHandler(async (req, res) => {
    ...
    return res.json(new ApiResponse(200, enquiries, "Enquiries Fetched Successfully"));
})
...
//write findby bookingType  (maybe in getAllEnquiry)
//write findby status  (maybe in getAllEnquiry)